...
wp_enqueue_style('style', get_bloginfo('template_directory').'/tyl_includes/css/style.css' );

wp_enqueue_script('bootstrap', get_bloginfo('template_directory').'/tyl_includes/js/bootstrap.js', array('jquery'), '1.0' );
wp_enqueue_script('tab', get_bloginfo('template_directory').'/tyl_includes/js/bootstrap-tab.js', array('jquery'), '1.0' );
